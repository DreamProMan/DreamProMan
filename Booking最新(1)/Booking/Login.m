...
@synthesize ConnectionDele,CurrentUserID=_CurrentUserID;
//得到URL
-(NSURL*)GetURL
{
...
-(void)loaduserID:(NSString *)userID upass:(NSString *)upass
{
    ...
    NSString * loadBody = [NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\" ?><root><head cid=\"01000004\" sver=\"A 2.0.0.240\" mac=\"1234567890123456\"><goods_type></goods_type><merc_id></merc_id><areaid></areaid><zip_type></zip_type><userid>%@</userid><sessionid></sessionid><actid></actid><sdid></sdid><simid></simid><clientid></clientid></head><body><upass>%@</upass></body></root>",userID,[self md5HexDigest:upass]];
    [self connectionWithbody:loadBody Info:@"用户登陆"];
    
//    NSString * downInformation = [NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\" ?><root><head cid=\"01000005\" sver=\"A 2.0.0.240\" mac=\"1234567890123456\"><goods_type></goods_type><merc_id></merc_id><areaid></areaid><zip_type></zip_type><userid>%@</userid><sessionid></sessionid><actid></actid><sdid></sdid><simid></simid><clientid></clientid></head><body><upass>%@</upass></body></root>",userID,[self md5HexDigest:upass]];
...
{
    [self.ConnectionDele didFinishConnect:request];
